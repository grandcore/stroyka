...
Данный проект создан с целью создать темплейт для дальнейшей разработки.
...
- web-public (контейнер web-public) ([localhost:5000](http://localhost:5000)) - Отрисовка всего фронта, кроме админки и процессов. На текущей момент выводит html файл со всеми ссылками на все приложения. 
